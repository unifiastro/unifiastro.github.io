...
if (!is_dir('proposals/pages')) mkdir('proposals/pages', 0777, true);
if (!is_dir('proposals/raw')) mkdir('proposals/raw', 0777, true);

$files = glob("proposals/pages/[0-9]*.html");
natsort($files); 
...
<body>
    <div class="container">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <a href="proposals/index.html" target="_blank" class="btn btn-blue">View Public Site</a>
        </div>
        <hr>
                ...
                <?php else: ?>
                    ...
                    <li>
                        ...
                        <div class="actions-col">
                            <a href="proposals/pages/<?= $p['name'] ?>" target="_blank" class="btn btn-blue">View</a>
                            <?php if($p['has_json']): ?>
